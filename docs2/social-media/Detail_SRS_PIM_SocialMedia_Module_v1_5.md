...
**Phiên bản:** 1.5**Ngày:** 08/06/2026**Trạng thái:** Draft**Tech stack:** .NET 8 · PostgreSQL · React.js · Hangfire · Redis**Team:** 1 Backend Developer

> **Changelog v1.5:**
>
> - **Chuyển Pinterest vào Phase 1** — tích hợp trực tiếp vào Sprint Plan 10 tuần
> - **Chuyển TikTok sang Phase 2** (thay thế vị trí Pinterest trước đây) — lý do: audit TikTok kéo dài 1–2 tháng, async chunked upload phức tạp
> - Cập nhật mục 2.1 In Scope: bổ sung Pinterest
> - Cập nhật mục 2.2 Out of Scope: thay Pinterest → TikTok
> - Cập nhật ISocialGateway / DI registration: uncomment Pinterest, comment TikTok
> - Cập nhật Enum Platform: bổ sung `pinterest`
> - Cập nhật ADR-009: đổi lý do loại TikTok thay vì Pinterest
> - Cập nhật Roadmap Sprint: tích hợp Pinterest Sprint 5, đẩy TikTok sang Phase 2
> - Cập nhật mục 18 đổi thành "TikTok Roadmap — Phase 2"
> - Cập nhật Phụ lục A: thêm cột Pinterest, bỏ cột TikTok
> - Cập nhật mục 5.4 Scalability: Pinterest Phase 1, TikTok Phase 2
...
18. [TikTok Roadmap — Phase 2](#18-tiktok-roadmap--phase-2)
...
- Đăng **Pinterest Pin** (ảnh, video, Rich Pin) — quản lý theo Board
...
- Quản lý quyền theo Page (`social_page_permissions`) và theo Board (Pinterest)
- Hashtag Library — quản lý hashtag group yêu thích
- UTM / URL Tracking — tự động gắn tham số UTM vào link (bao gồm `destination_url` của Pin)
- Đồng bộ analytics tự động (impressions, reach, likes, comments, shares, saves)
- Export báo cáo Analytics (Excel / CSV)
- Sales View: tra cứu lịch sử đăng bài theo sản phẩm, theo page/board, theo nền tảng
...
- Webhook receiver xử lý callback từ Meta và Pinterest

### 2.2 Ngoài phạm vi (Out of Scope) — Phase 1

- **TikTok** — chuyển sang Phase 2 (audit kéo dài 1–2 tháng, async chunked upload phức tạp, rủi ro cao với team 1 dev)
...
### 3.3 Client Prerequisites & External Dependencies

#### Mục đích

Module Social Media Publishing phụ thuộc vào các tài khoản Business và Developer Platform của bên khách hàng. Các tài khoản này phải được tạo và cấp quyền trước khi bắt đầu Sprint tích hợp Facebook, Instagram và Pinterest.

Nếu các điều kiện dưới đây chưa hoàn thành, tiến độ phát triển và kiểm thử API có thể bị ảnh hưởng.

---

#### CP-001: Meta Business Portfolio (Facebook Business Manager)

Khách hàng phải cung cấp hoặc tạo sẵn:

* Meta Business Portfolio (trước đây là Facebook Business Manager)
* Quyền Business Admin
* Danh sách Facebook Pages sẽ được quản lý trong PIM
* Kết nối Instagram Business Account với Facebook Page tương ứng

**Thông tin cần xác nhận:**

| Thông tin                             | Bắt buộc |
| -------------------------------------- | ---------- |
| Đã có Meta Business Portfolio       | Yes        |
| Business Verification hoàn tất       | Yes        |
| Danh sách Facebook Pages              | Yes        |
| Danh sách Instagram Business Accounts | Yes        |
| Người sở hữu Business Admin        | Yes        |

---

#### CP-002: Meta Developer App

Khách hàng phải tạo hoặc cho phép tạo Meta Developer App phục vụ tích hợp API.
...
* Cung cấp App ID
* Cung cấp App Secret (qua kênh bảo mật)

**Quyền API dự kiến sử dụng:**
...
Một số quyền yêu cầu App Review từ Meta trước khi sử dụng ở môi trường Production.

---

#### CP-003: Pinterest Business Account & App

Khách hàng phải chuẩn bị:

* Pinterest Business Account
* Pinterest Developer App
* Quyền truy cập Pinterest API

**Thông tin cần xác nhận:**

| Thông tin                         | Bắt buộc |
| ---------------------------------- | ---------- |
| Pinterest Business Account         | Yes        |
| Pinterest App                      | Yes        |
| API Access Approved                | Yes        |
| Người sở hữu tài khoản Admin | Yes        |

---

#### CP-004: Business Administrator Contact

Khách hàng phải chỉ định ít nhất một người chịu trách nhiệm quản trị các nền tảng Social Media.

Người này sẽ chịu trách nhiệm:

* Xác thực doanh nghiệp với Meta
* Quản lý Facebook Pages
* Quản lý Instagram Business Accounts
* Quản lý Pinterest Business Account
* Tạo và quản lý Developer App
* Phê duyệt các yêu cầu OAuth và App Review
* Cấp quyền cho đội dự án khi cần

**Thông tin yêu cầu:**

| Thông tin                  | Mô tả                                         |
| --------------------------- | ----------------------------------------------- |
| Họ tên                    | Business Administrator                          |
| Email công việc           | Bắt buộc                                      |
| Vai trò                    | Marketing Manager / IT Manager / Business Owner |
| Quyền sở hữu tài khoản | Business Admin                                  |

---

#### CP-005: Timeline Dependency

Các hạng mục dưới đây nằm ngoài phạm vi phát triển phần mềm nhưng là điều kiện tiên quyết cho việc tích hợp API:

| Hạng mục                      | Thời gian dự kiến |
| ------------------------------- | -------------------- |
| Tạo Meta Business Portfolio    | 1 ngày              |
| Business Verification           | 1–7 ngày           |
| Tạo Meta Developer App         | 1 ngày              |
| Meta App Review                 | 3–14 ngày          |
| Tạo Pinterest Business Account | 1 ngày              |
| Pinterest API Approval          | 1–7 ngày           |

**Rủi ro:**

Nếu các tài khoản trên chưa được chuẩn bị hoặc chưa được phê duyệt bởi Meta/Pinterest, việc tích hợp Facebook, Instagram và Pinterest có thể bị trì hoãn mặc dù phần mềm đã hoàn thành.

---

#### Trạng thái hiện tại (08/06/2026)

| Hạng mục                 | Trạng thái      |
| -------------------------- | ----------------- |
| Meta Business Portfolio    | Chưa xác nhận  |
| Meta Business Verification | Chưa xác nhận  |
| Meta Developer App         | Chưa có         |
| Pinterest Business Account | Chưa xác nhận  |
| Pinterest Developer App    | Chưa có         |
| Business Administrator     | Chưa xác định |

**Risk Level:** HIGH

Cần hoàn tất các hạng mục trên trước khi bắt đầu Sprint tích hợp Facebook, Instagram và Pinterest.
...
**Pinterest:** Pinterest có destination URL riêng — UTM gắn vào `destination_url` của Pin, không phải caption. Đã hỗ trợ trong Phase 1 qua `POST /api/pinterest/utm/preview`.
...
- Kiến trúc `ISocialGateway` cho phép thêm nền tảng mới (TikTok Phase 2) mà không sửa business logic
- Pinterest dùng `IPinterestGateway` riêng (Board-centric, khác cấu trúc ISocialGateway) — đã tích hợp Phase 1
...
// Pinterest dùng IPinterestGateway riêng (Board-centric architecture)
services.AddScoped<IPinterestGateway, PinterestAdapter>();
// TikTok: Phase 2
...
public enum SocialPlatform
{
    ...
    LinkedIn  = 4,
    // TikTok = 3,    // Phase 2
    // Pinterest = 5 (Phase 1 — IPinterestGateway riêng)
}
```
...
> **Team: 1 Developer · Timeline: 10 tuần (+ Sprint 0)**
> **v1.5: Pinterest chuyển vào Phase 1 — Sprint 5 mở rộng để tích hợp Pinterest + LinkedIn**
>
> **Sprint 0 là giai đoạn chuẩn bị tài khoản Business và Developer Platform từ phía khách hàng.**

### Sprint 0 — Tuần 0–1: Platform Setup & External Dependencies

> **Mục tiêu:** Hoàn tất các điều kiện tiên quyết từ phía khách hàng để có thể phát triển và kiểm thử Facebook, Instagram và Pinterest API.

| Task                            | Owner        | Mô tả                                                                            |
| ------------------------------- | ------------ | ---------------------------------------------------------------------------------- |
| Meta Business Portfolio Setup   | Client       | Tạo hoặc xác nhận Meta Business Portfolio (Facebook Business Manager)          |
| Business Verification           | Client       | Hoàn tất xác thực doanh nghiệp với Meta                                      |
| Facebook Page Inventory         | Client       | Cung cấp danh sách Facebook Pages sẽ tích hợp                                 |
| Instagram Account Inventory     | Client       | Cung cấp danh sách Instagram Business Accounts tương ứng                      |
| Pinterest Business Setup        | Client       | Tạo Pinterest Business Account                                                    |
| Meta Developer App Registration | Client / Dev | Tạo Meta Developer App                                                            |
| Pinterest App Registration      | Client / Dev | Tạo Pinterest Developer App                                                       |
| OAuth Redirect Configuration    | Dev          | Cung cấp Redirect URLs cho môi trường DEV/UAT/PROD                             |
| Meta App Configuration          | Dev          | Cấu hình Products, Permissions và Webhook URLs                                  |
| API Permission Review           | Dev          | Chuẩn bị hồ sơ App Review cho Meta                                             |
| Admin Contact Assignment        | Client       | Chỉ định Business Administrator chịu trách nhiệm cấp quyền và phê duyệt |

#### Deliverables

* Meta Business Portfolio đã được tạo và xác thực
* Facebook Pages đã được thêm vào Business
* Instagram Business Accounts đã được liên kết với Facebook Pages
* Meta Developer App được tạo thành công
* Pinterest Developer App được tạo thành công
* OAuth Redirect URLs được cấu hình
* Danh sách Platform Accounts và Social Pages được xác nhận
* Business Administrator được chỉ định
...
* Facebook Pages có thể truy cập thông qua Graph API Explorer
* Instagram Business Accounts xuất hiện trong Graph API
* Development Team nhận được App ID và các thông tin cấu hình cần thiết

#### Risks

| Risk                                          | Impact                                         |
| --------------------------------------------- | ---------------------------------------------- |
| Business Verification bị từ chối           | Không thể chuyển sang Production            |
| Meta App Review kéo dài                     | Chậm tiến độ tích hợp Facebook/Instagram |
| Chưa xác định Business Admin              | Không thể cấp quyền hoặc xác thực       |
| Facebook Pages không thuộc Business         | Không thể publish qua API                    |
| Instagram Account chưa chuyển sang Business | Không thể publish Instagram Content API      |

#### Timeline Impact

Sprint 0 không bao gồm phát triển tính năng nghiệp vụ.

Nếu Sprint 0 chưa hoàn thành, các Sprint tích hợp Facebook, Instagram và Pinterest sẽ bị block do phụ thuộc vào nền tảng bên thứ ba.

### Sprint 1 — Tuần 1–2: Foundation + Multi-Page + Permission

| Task                         | Mô tả                                                                                                                                                                                                                                                                         |
| ---------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Schema & Migration           | EF Core migration: 10 bảng core bao gồm `social_page_permissions`, `social_post_templates`, `social_hashtag_groups`, `social_notifications` + 4 bảng Pinterest: `pinterest_boards`, `pinterest_pins`, `pinterest_pin_analytics`, `pinterest_board_analytics` |
| ISocialGateway interface     | Domain entities, Enum Platform/Status (bỏ TikTok = 3, thêm Pinterest = 4), Records                                                                                                                                                                                            |
| Meta OAuth flow              | FB Login → callback → lấy danh sách Pages → lưu từng Page                                                                                                                                                                                                                |
| Pinterest OAuth flow         | Pinterest Business Login → callback → lấy danh sách Boards → lưu từng Board                                                                                                                                                                                              |
| Page Permission setup        | CRUD `social_page_permissions`, middleware kiểm tra quyền (FR-019); Board Permission tương tự cho Pinterest                                                                                                                                                              |
| TokenManager                 | IHostedService: daily check + alert qua Notification (FR-015) — bao gồm Pinterest token (Access 1h + Refresh 365d)                                                                                                                                                            |
| MetaHttpClient + Polly       | Retry 3 lần, circuit breaker                                                                                                                                                                                                                                                   |
| Notification Center (schema) | Bảng + API GET/PATCH, chưa có UI                                                                                                                                                                                                                                             |

**DoD:** Connect Facebook + Pinterest, lưu Pages và Boards, phân quyền Page/Board cho user hoạt động.
...
### Sprint 5 — Tuần 9–10: LinkedIn + Pinterest + Delete + Polish + UAT

| Task                             | Mô tả                                                                                                                                  |
| -------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------- |
| LinkedInAdapter via Zernio       | HttpClient đơn giản, cùng ISocialGateway interface                                                                                   |
| Pinterest Pin Publisher          | `IPinterestGateway.PublishPinAsync` — image Pin + video Pin, gắn UTM vào `destination_url`                                        |
| Pinterest Board Management UI    | Connect account, list Boards, enable/disable Board                                                                                       |
| Pinterest Analytics sync         | Hangfire job mỗi 24h (Pin mới) / mỗi 7 ngày (Pin cũ > 30 ngày), upsert `pinterest_pin_analytics` + `pinterest_board_analytics` |
| Pinterest Sales View             | Tab "Pinterest Pins" trên trang sản phẩm: filter theo Board, metrics Saves / Outbound Clicks                                          |
| Rich Pin support                 | Toggle "Kích hoạt Rich Pin" — verify OG metadata trên destination URL                                                                |
| Bulk Pin Scheduling              | FR-009 variant cho Pinterest: phân phối đều N Pin trong khoảng thời gian                                                           |
...
| Integration tests                | Test toàn bộ flow: publish Meta + LinkedIn + Pinterest, duplicate, bulk, delete, export                                                |
| Performance testing              | SP query time, bulk job throughput                                                                                                       |
| UAT                              | Kiểm thử với Marketing và Sales                                                                                                      |

**DoD:** 3 nền tảng (Meta + LinkedIn + Pinterest) hoạt động hoàn chỉnh. Tất cả FR v1.5 pass UAT. Sẵn sàng production.
...
| #       | Quyết định                                    | Lý do                                                                                                                                                                    |
| ------- | ------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ADR-001 | `ISocialGateway` abstraction layer             | Tránh vendor lock-in, dễ thêm nền tảng mới (TikTok Phase 2), testable                                                                                               |
...
| ADR-009 | **Loại TikTok khỏi Phase 1**             | Audit TikTok 1–2 tháng + async chunked upload phức tạp không phù hợp với team 1 dev và timeline 10 tuần                                                         |
| ADR-013 | **Pinterest vào Phase 1**                 | API v5 miễn phí, OAuth 2.0 đơn giản, Board-centric model khác nhưng có thể tích hợp riêng qua `IPinterestGateway`. Marketing cần Pinterest trước TikTok. |
...
## 18. TikTok Roadmap — Phase 2

> TikTok được loại khỏi Phase 1 do audit kéo dài 1–2 tháng và quy trình upload video phức tạp (async chunked upload). Phase 2 bắt đầu sau khi Phase 1 stable, ước tính 4–6 tuần.

### 18.1 Lý do hoãn TikTok sang Phase 2

| Rào cản        | Chi tiết                                                                                                       |
| ---------------- | --------------------------------------------------------------------------------------------------------------- |
| App Review       | TikTok For Business yêu cầu review 1–2 tháng trước khi được publish qua API                            |
| Video upload     | Chunked upload bắt buộc (không hỗ trợ single-part upload cho video dài) → phức tạp hơn Meta/Pinterest |
| Audit compliance | TikTok Business API yêu cầu privacy policy, use-case review nghiêm ngặt                                     |
| Team constraint  | Team 1 dev — rủi ro cao nếu audit trễ sẽ block toàn bộ Phase 1                                           |

### 18.2 Khái niệm đặc thù của TikTok

| Khái niệm             | Giải thích                                                                               |
| ----------------------- | ------------------------------------------------------------------------------------------ |
| TikTok Business Account | Tài khoản doanh nghiệp đã verify — bắt buộc để dùng Content Posting API         |
| Content Posting API     | API cho phép publish video lên TikTok từ bên ngoài                                    |
| Chunked Upload          | Video phải upload theo từng phần (chunk), sau đó complete — tương tự S3 multipart |
| Privacy Level           | Mức độ hiển thị bài đăng: PUBLIC, MUTUAL_FOLLOW_FRIENDS, SELF_ONLY                 |
| Duet / Stitch           | Tính năng tương tác TikTok — không scope trong Phase 2                              |

### 18.3 Database Schema bổ sung cho TikTok
...
CREATE TABLE tiktok_posts (
    ...
    product_item_id    UUID         NOT NULL REFERENCES product_items(id),
    account_id         UUID         NOT NULL REFERENCES social_platform_accounts(id),
    tiktok_video_id    VARCHAR(200),          -- ID video sau khi publish
    post_url           TEXT,
    caption            TEXT,                  -- Tối đa 2,200 ký tự
    hashtags           TEXT,
    privacy_level      VARCHAR(30)  NOT NULL DEFAULT 'PUBLIC',
    status             VARCHAR(20)  NOT NULL DEFAULT 'Draft',
    upload_session_id  VARCHAR(200),          -- TikTok upload session cho chunked upload
    scheduled_at       TIMESTAMPTZ,
    published_at       TIMESTAMPTZ,
    error_message      TEXT,
    retry_count        INT          NOT NULL DEFAULT 0,
...
CREATE INDEX idx_tiktok_posts_product ON tiktok_posts(product_item_id);
CREATE INDEX idx_tiktok_posts_sched   ON tiktok_posts(scheduled_at) WHERE status = 'Scheduled';

CREATE TABLE tiktok_post_analytics (
    id              UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    ...
    engagement_rate FLOAT,
    raw_payload     JSONB,
    UNIQUE (tiktok_post_id, synced_at)
);
```

### 18.4 Luồng Upload Video TikTok (Chunked)

```
1. POST /v2/post/publish/inbox/video/init
   → Lấy upload_url + publish_id + upload_session_id
2. PUT upload_url với từng chunk (chunk size 5MB–64MB)
3. POST /v2/post/publish/inbox/video/complete
   → publish_id sẵn sàng
4. POST /v2/post/publish/video/init
   → Submit post với caption, hashtags, privacy_level
   → Lấy video_id sau khi TikTok review xong (async, có thể mất 1–24h)
```

> Toàn bộ luồng chunked upload cần Hangfire job chain (ContinueJobWith) để orchestrate các bước async.

### 18.5 ITikTokGateway Interface

```csharp
public interface ITikTokGateway
{
    Task<TikTokUploadSession> InitUploadAsync(long fileSizeBytes, string accessToken, CancellationToken ct);
    Task UploadChunkAsync(string uploadUrl, byte[] chunk, int chunkIndex, CancellationToken ct);
    Task<string> CompleteUploadAsync(string uploadSessionId, string accessToken, CancellationToken ct);
    Task<TikTokPublishResult> PublishVideoAsync(TikTokPublishRequest request, CancellationToken ct);
    Task<TikTokAnalyticsResult> GetVideoAnalyticsAsync(string videoId, string accessToken, CancellationToken ct);
    Task<bool> DeleteVideoAsync(string videoId, string accessToken, CancellationToken ct);
}
...
public record TikTokPublishRequest(
    ...
    bool AllowStitch = false);
```

### 18.6 TikTok API — Tóm tắt kỹ thuật

| Thuộc tính   | Giá trị                                                 |
| -------------- | --------------------------------------------------------- |
| API            | TikTok Content Posting API v2                             |
| Chi phí       | Miễn phí (cần Business Account đã verify)            |
| Authentication | OAuth 2.0 + PKCE                                          |
| Token expiry   | Access Token 24 giờ, Refresh Token 365 ngày             |
| Rate limit     | 100 requests/ngày (sandbox), tăng sau audit             |
| App Review     | Bắt buộc — 1–2 tháng, cần privacy policy + use case |
| Upload         | Chunked upload (5MB–64MB mỗi chunk)                     |
| Webhook        | Có (video.publish.complete)                              |
| Content review | Video có thể bị hold 1–24h cho TikTok review          |

### 18.7 Sprint Plan Phase 2 (TikTok)

> Ước tính 4–6 tuần sau khi Phase 1 stable. Điều kiện tiên quyết: App Review đã được phê duyệt trước khi bắt đầu.

| Sprint      | Nội dung                                                        |
| ----------- | ---------------------------------------------------------------- |
| P2-Sprint 1 | TikTok OAuth PKCE, account management, token refresh             |
| P2-Sprint 2 | Chunked video upload flow (Hangfire job chain), Draft management |
| P2-Sprint 3 | Publish, schedule, retry, Dead Letter cho TikTok                 |
| P2-Sprint 4 | Analytics sync (views, likes, shares), Sales View TikTok         |
| P2-Sprint 5 | Bulk video scheduling, Integration tests, UAT, Production deploy |

---

## Phụ lục A — Bảng so sánh API nền tảng (Phase 1)

|                            | Meta Graph API                     | LinkedIn (Zernio)  | Pinterest API v5           |
| -------------------------- | ---------------------------------- | ------------------ | -------------------------- |
| **Chi phí**         | Miễn phí                         | ~$6/account/tháng | Miễn phí                 |
| **Auth**             | OAuth 2.0 → Page Token (per Page) | API Key            | OAuth 2.0 + PKCE           |
| **Token expiry**     | 60 ngày / Page                    | N/A (Zernio lo)    | Access 1h / Refresh 365d   |
| **Multi-page**       | Có — /me/accounts                | Có (qua Zernio)   | Multi-Board — /boards     |
| **Content type**     | Ảnh, video, text, carousel        | Ảnh, video, text  | Ảnh, video (Pin)          |
| **Post limit/ngày** | 25 (IG) / unlimited (FB)           | Unlimited          | 100 Pins/ngày             |
| **Analytics API**    | Đầy đủ                         | Included (Zernio)  | Có (Pin + Board)          |
| **App Review**       | Bắt buộc (vài tuần)            | Không cần        | Cần Standard Access       |
| **Webhook**          | Có                                | Zernio lo          | Có (Pin & Board events)   |
| **Delete Post**      | DELETE /{post-id}                  | Qua Zernio         | DELETE /pins/{pin_id}      |
| **Đặc thù**       | Multi-Page per account             | Managed by Zernio  | Board-centric, SEO traffic |
| **Độ phức tạp**  | Trung bình                        | Thấp              | Trung bình                |

---

## Phụ lục B — API Endpoints tóm tắt (v1.5)
...
# Pinterest Boards
GET    /api/pinterest/boards                        Danh sách tất cả Boards
GET    /api/pinterest/boards/my-boards              Boards user được phân quyền
PATCH  /api/pinterest/boards/{id}/toggle           Enable / Disable Board
GET    /api/pinterest/permissions/boards           (Admin) Toàn bộ phân quyền Board
POST   /api/pinterest/permissions/boards           (Admin) Cấp quyền Board: { userId, boardIds[] }
DELETE /api/pinterest/permissions/boards/{userId}/{boardId}  (Admin) Thu hồi quyền

# Pinterest Pins
POST   /api/pinterest/pins                          Tạo và đăng Pin (hoặc schedule)
POST   /api/pinterest/pins/draft                    Tạo Pin Draft
PATCH  /api/pinterest/pins/{id}                     Cập nhật Pin Draft
DELETE /api/pinterest/pins/{id}                     Xóa Pin (Draft → hard; Published → soft)
PATCH  /api/pinterest/pins/{id}/reschedule          Đổi scheduled_at
GET    /api/pinterest/pins/product/{productId}      Lịch sử Pins theo sản phẩm
GET    /api/pinterest/pins/{id}                     Chi tiết 1 Pin
POST   /api/pinterest/utm/preview                   Preview URL sau khi gắn UTM (destination_url)
POST   /api/pinterest/richpin/verify                Verify Open Graph metadata trên destination URL

# Pinterest Analytics
GET    /api/pinterest/analytics/pins/{id}           Analytics theo Pin
GET    /api/pinterest/analytics/boards/{id}         Analytics theo Board
GET    /api/pinterest/analytics/dashboard           Tổng hợp metrics Pinterest

# Webhooks
POST   /webhooks/meta                               Meta webhook (bài xóa, video processed)
POST   /webhooks/pinterest                          Pinterest webhook (Pin events, Board events)
```
...
# Webhooks (bên cạnh Pinterest endpoints đã thêm ở trên)

POST   /webhooks/meta                               Meta webhook (bài xóa, video processed)
POST   /webhooks/pinterest                          Pinterest webhook (Pin & Board events)

```

---

## Phụ lục C — Data Access Mapping (EF Core vs Dapper) — v1.5
...
| POST /pinterest/pins | **EF Core Insert** | `PinterestPins.Add()` |
| PATCH /pinterest/pins/{id}/reschedule | **EF Core Update** | `ExecuteUpdateAsync()` |
| DELETE /pinterest/pins/{id} (Published) | **EF Core Update** | `UpdateStatus(Deleted)` |
| Pinterest analytics upsert | **EF Core Insert** | `AddOrUpdate()` |
...
| GET pinterest/pins/product/{id} | **Dapper + SP** | `sp_GetPinsByProduct` |
| GET pinterest/analytics/boards/{id} | **Dapper + SP** | `sp_GetBoardAnalytics` |
| Token check (background) | **Dapper** | Raw query (SELECT only) |

---

*Tài liệu SRS — PIM Social Media Module*  
*Phiên bản: 1.5 · Cập nhật: 08/06/2026*  
*Phiên bản tiếp theo sẽ bổ sung: Sequence diagrams Pinterest, Test plan, Deployment guide*
